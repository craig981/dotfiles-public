...
(defun my-theme-solarized ()
  (interactive)
  (mapcar #'disable-theme custom-enabled-themes)
  (require 'solarized-dark-high-contrast-theme)
...
(global-set-key (kbd "C-c w s") 'my-theme-solarized)
