...
(global-set-key (kbd "M-s M-a") (lambda ()
				  (interactive)
...
(defhydra my-theme-hydra ()
  ...
  ("o" (lambda () (interactive) (my-theme-dark 2)) "doom-nord")
