...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((,class (:box (:line-width 6 :color ,bg2) :bold t :foreground ,fg4 :background ,bg2))))
   `(mode-line-inactive ((,class (:box (:line-width 6 :color ,bg1) :foreground ,var :background ,bg1 :weight normal))))
